...
// {'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'state_estimator': ['/home/jinzhao/catkin_ws5/src/state_estimator/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
struct MD5Sum< ::state_estimator::SensorData_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x71af189c7d826d77ULL;
  static const uint64_t static_value2 = 0x6a3face61f3225dbULL;
};
...
struct Definition< ::state_estimator::SensorData_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# The forward translational velocity commanded to the robot\n\
float64 vel_trans\n\
\n\
