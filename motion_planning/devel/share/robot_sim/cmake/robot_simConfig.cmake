...
if("TRUE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /home/jinzhao/catkin_ws4/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /home/jinzhao/catkin_ws4/devel)
  ...
  set(robot_sim_INSTALL_PREFIX /home/jinzhao/catkin_ws4/install)
...
if(NOT "/home/jinzhao/catkin_ws4/src/robot_sim/include " STREQUAL " ")
  set(robot_sim_INCLUDE_DIRS "")
  set(_include_dirs "/home/jinzhao/catkin_ws4/src/robot_sim/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jinzhao/catkin_ws4/src/robot_sim/${idir}'.  Ask the maintainer 'matei <matei@todo.todo>' to fix it.")
    endif()
