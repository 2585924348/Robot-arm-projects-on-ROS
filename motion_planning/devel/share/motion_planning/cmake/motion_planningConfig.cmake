...
if("TRUE" STREQUAL "TRUE")
  set(motion_planning_SOURCE_PREFIX /home/jinzhao/catkin_ws4/src/motion_planning)
  set(motion_planning_DEVEL_PREFIX /home/jinzhao/catkin_ws4/devel)
  ...
  set(motion_planning_INSTALL_PREFIX /home/jinzhao/catkin_ws4/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'motion_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jinzhao/catkin_ws4/src/motion_planning/${idir}'.  Ask the maintainer 'matei <matei@todo.todo>' to fix it.")
    endif()
...
set(depends "actionlib;control_msgs;interactive_markers;moveit_commander;moveit_msgs;rospy;sensor_msgs;tf")
