...
if("TRUE" STREQUAL "TRUE")
  set(cartesian_control_SOURCE_PREFIX /home/jinzhao/catkin_ws4/src/cartesian_control)
  set(cartesian_control_DEVEL_PREFIX /home/jinzhao/catkin_ws4/devel)
  ...
  set(cartesian_control_INSTALL_PREFIX /home/jinzhao/catkin_ws4/install)
...
if(NOT "/home/jinzhao/catkin_ws4/devel/include " STREQUAL " ")
  set(cartesian_control_INCLUDE_DIRS "")
  set(_include_dirs "/home/jinzhao/catkin_ws4/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cartesian_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jinzhao/catkin_ws4/src/cartesian_control/${idir}'.  Ask the maintainer 'matei <matei@todo.todo>' to fix it.")
    endif()
...
set(cartesian_control_EXPORTED_TARGETS "cartesian_control_generate_messages_cpp;cartesian_control_generate_messages_eus;cartesian_control_generate_messages_lisp;cartesian_control_generate_messages_nodejs;cartesian_control_generate_messages_py")
...
set(depends "message_runtime;interactive_markers;rospy;sensor_msgs;tf;urdfdom_py;geometry_msgs")
...
set(pkg_cfg_extras "cartesian_control-msg-extras.cmake")
